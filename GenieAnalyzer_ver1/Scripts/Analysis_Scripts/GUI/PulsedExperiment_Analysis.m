function varargout = PulsedExperiment_Analysis(varargin)
% PULSEDEXPERIMENT_ANALYSIS MATLAB code for PulsedExperiment_Analysis.fig
%      PULSEDEXPERIMENT_ANALYSIS, by itself, creates a new PULSEDEXPERIMENT_ANALYSIS or raises the existing
%      singleton*.
%
%      H = PULSEDEXPERIMENT_ANALYSIS returns the handle to a new PULSEDEXPERIMENT_ANALYSIS or the handle to
%      the existing singleton*.
%
%      PULSEDEXPERIMENT_ANALYSIS('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in PULSEDEXPERIMENT_ANALYSIS.M with the given input arguments.
%
%      PULSEDEXPERIMENT_ANALYSIS('Property','Value',...) creates a new PULSEDEXPERIMENT_ANALYSIS or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before PulsedExperiment_Analysis_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to PulsedExperiment_Analysis_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help PulsedExperiment_Analysis

% Last Modified by GUIDE v2.5 07-Aug-2018 10:36:02

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @PulsedExperiment_Analysis_OpeningFcn, ...
                   'gui_OutputFcn',  @PulsedExperiment_Analysis_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before PulsedExperiment_Analysis is made visible.
function PulsedExperiment_Analysis_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to PulsedExperiment_Analysis (see VARARGIN)

% Choose default command line output for PulsedExperiment_Analysis
...
function varargout = PulsedExperiment_Analysis_OutputFcn(hObject, eventdata, handles) 
